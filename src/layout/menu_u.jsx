...
const LinkItems = [
  { name: "Working", icon: FiHome, link: "/working" },
  // { name: "Planning", icon: FiCompass ,link:'/Planning'},
...
export default function Menu_web_u({ sysname }) {
          ...
          <HStack spacing={2} alignItems={"center"}>
            ...
            >
              ...
              <Text fontSize={{ base: "15px", md: "20px", lg: "30px" }}>
                <b style={{ color: "red", marginLeft: "15px" }}>SNC</b> Cooling
                : IIoT
              </Text>
            </Box>
            <HStack

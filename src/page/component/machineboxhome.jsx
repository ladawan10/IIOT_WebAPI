...
export default function Machineboxhome({ namemc, mcid, datamc }) {
              ...
              <Grid templateColumns="repeat(3, 1fr)" gap={2}>
                ...
                >
                  ...
                  <Grid
                    ...
                    gap={4}
                    style={{ fontSize: "var(--chakra-fontSizes-lg)" }}
                  >
                    <div>Plan Target:</div>
                    <div>{order_inprocess[0]?.PlanTargetQty}</div>
                    <div>Actual:</div>
                    <div>
